...
A modern, responsive movie discovery web application built with React and powered by The Movie Database (TMDB) API.
...
3. Configure API Key - Create a .env file
   ...
   VITE TMDB API KEY= My tmdb api key (paste here)
...
2. Focus on search functionality only
3. Light and dark mode   
4. Favorites list
5. Fast loading
6. Responsive layout
7. Simple and fast UX
8. Lazy Loading 
9. Debounced search
10. Context Api
11. local storage
...
7. Add Movie Reviews
8. Add Movie Cast & Crew
9. Add Movie Recommendations
