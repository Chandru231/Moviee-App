  ...
  return (
    <div className="relative max-w-xl mx-auto px-2 sm:px-0">
      <input
        ...
        className="w-full px-4 py-2.5 md:py-3 pl-10 md:pl-12 rounded-full bg-white dark:bg-gray-800 text-gray-800 dark:text-white border border-gray-300 dark:border-gray-700 focus:border-red-500 focus:outline-none transition-colors text-sm md:text-base"
      />
